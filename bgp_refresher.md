...
> This is exactly the mechanism RPKI and BGPsec protect: RPKI/ROV checks that the **rightmost (origin) ASN** — here `64500` — is actually authorized to announce `203.0.113.0/24`, while BGPsec cryptographically signs the whole `[64502 64501 64500]` chain so no AS can forge or shorten it.
